...
for(i = 0; i < 4; i += 1) {
	...
	light = instance_create_layer(900-sprite_width, 50 + 200 *ds_list_find_value(randomstart,i),"Instances",obj_lightcheck);
